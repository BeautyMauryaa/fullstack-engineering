...
//1.selecting element: 
//-queryselctor(return null if nothing matches) and querselctorall

document.querySelector('#app');//first match or null
document.querySelector('.card h2');//nested css selector
document.querySelectorAll('.item');//node list of all matches
...
el.textContent=userInput;//safe treats as plain text
el.innerHTML='<b>Hi</b>';//not safe-xss

el.textContent;//read all text inside
el.innerHTML;//read inner html string
